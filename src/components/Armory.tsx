...
const games: ArmoryGame[] = [
  { title: 'Carcassonne', level: 'Foundation', players: '2-5', duration: 45, difficulty: 'Moderate', mechanics: ['Tile Placement', 'Area Control'], focus: ['Language Focus', 'Tactical Communication'], mission: 'Build a shared map and explain why each claim matters.', fieldUse: 'Excellent first tactical table for spatial language and polite challenge phrases.' },
  { title: 'Modern Art', level: 'Intermediate', players: '3-5', duration: 45, difficulty: 'Expert', mechanics: ['Auction', 'Set Collection'], focus: ['Negotiation'], mission: 'Read the table, price the market, and justify every bid.', fieldUse: 'Sharp practice for auction language, persuasion, and confidence under time pressure.' },
  { title: 'High Society', level: 'Intermediate', players: '3-5', duration: 30, difficulty: 'Moderate', mechanics: ['Economic Simulation', 'Strategy'], focus: ['Language Focus', 'Tactical Communication'], mission: 'Chase prestige without becoming the poorest player.', fieldUse: 'Good for status language, comparisons, and explaining risk in short turns.' },
  { title: 'Airlines Europe', level: 'Intermediate', players: '2-5', duration: 75, difficulty: 'Expert', mechanics: ['Economic Simulation', 'Strategy'], focus: ['Negotiation'], mission: 'Invest in routes and airline shares before the table sees the value.', fieldUse: 'Useful for business English around growth, timing, investment, and leverage.' },
  { title: 'Smartphone Inc.', level: 'Intermediate', players: '1-5', duration: 90, difficulty: 'Expert', mechanics: ['Economic Simulation', 'Strategy'], focus: ['Business Terminology'], mission: 'Launch products, set prices, and dominate regions through tech strategy.', fieldUse: 'A strong business-English simulation for market positioning and product language.', featured: true },
  { title: 'Brass: Birmingham', level: 'Advanced', players: '2-4', duration: 120, difficulty: 'Heavy', mechanics: ['Network Building', 'Economic Management'], focus: ['Strategic Planning'], mission: 'Coordinate industry, transport, beer, coal, and timing across two eras.', fieldUse: 'Advanced practice for explaining dependencies, bottlenecks, and long-term plans.' },
  { title: 'Power Grid', level: 'Advanced', players: '2-6', duration: 120, difficulty: 'Expert', mechanics: ['Network Building', 'Economic Management'], focus: ['Strategic Planning'], mission: 'Bid for power plants and manage fuel before expanding your network.', fieldUse: 'Ideal for auction language, resource forecasting, and economic cause-effect talk.' },
  { title: 'RA', level: 'Advanced', players: '2-5', duration: 60, difficulty: 'Expert', mechanics: ['Auction', 'Set Collection'], focus: ['Tactical Communication'], mission: 'Control when auctions happen and decide which risks are worth the sun discs.', fieldUse: 'Great for probability language, brinkmanship, and concise strategic justification.' },
  { title: 'La Granja', level: 'Advanced', players: '1-4', duration: 120, difficulty: 'Heavy', mechanics: ['Economic Simulation', 'Strategy'], focus: ['Strategic Planning'], mission: 'Turn multi-use cards into a farm engine that delivers at the right moment.', fieldUse: 'Useful for sequencing language, planning explanations, and trade-off vocabulary.' },
  { title: 'Acquire', level: 'Advanced', players: '2-6', duration: 90, difficulty: 'Expert', mechanics: ['Economic Simulation', 'Strategy'], focus: ['Tactical Communication'], mission: 'Trigger mergers, hold shares, and explain why the market is about to move.', fieldUse: 'Excellent for finance vocabulary, prediction, and negotiation over visible incentives.' },
  { title: 'Terraforming Mars', level: 'Master', players: '1-5', duration: 120, difficulty: 'Expert', mechanics: ['Economic Simulation', 'Resource Management'], focus: ['Strategic Planning'], mission: 'Use corporate projects to raise oceans, oxygen, heat, cities, and forests.', fieldUse: 'Master-level language for scientific plans, project pitches, and multi-step strategy.' },
  { title: 'Great Western Trail', level: 'Master', players: '2-4', duration: 150, difficulty: 'Heavy', mechanics: ['Economic Simulation', 'Strategy'], focus: ['Strategic Planning'], mission: 'Drive cattle, improve your deck, hire workers, and deliver through the rail network.', fieldUse: 'Deep practice for route planning, opportunity cost, and layered decision explanation.' },
];
                  ...
                  return (
                    <button key={game.title} type="button" onClick={() => setSelectedTitle(game.title)} className="tactical-card overflow-hidden text-left transition hover:-translate-y-0.5 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#e28a24]">
                      ...
                      <div className="p-5">
                        ...
                        <p className="mt-3 rounded border border-[#efd08e] bg-[#fff9e9] p-3 text-[10px] leading-5 text-[#5f554c]"><Crosshair className="mr-1 inline text-[#dc7c20]" size={11} />{game.mission}</p>
            ...
            <div className="grid gap-6 p-6 lg:grid-cols-[320px_1fr]">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-xl border border-[#efd49d] bg-[#fff9e9] p-5">
                  <h3 className="font-display text-xl tracking-wide text-[#3d332b]">Mission Use</h3>
                  <p className="mt-3 text-sm leading-7 text-[#6f655a]">{selectedArmoryGame.mission}</p>
