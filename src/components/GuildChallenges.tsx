        ...
        <div className="mt-7 grid gap-4 sm:grid-cols-3">
          {challenges.map((challenge) => (
            <article key={challenge.title} className="tactical-card overflow-hidden">
              <div className="h-24 bg-gradient-to-br from-[#f2ddc0] to-[#e8edf4]" />
              <div className="p-4">
                <span className={`pill ${challenge.color}`}>{challenge.level}</span>
                <p className="mt-4 text-[10px] font-bold uppercase text-[#d06a24]">{challenge.game}</p>
